    ...
    <div className="flex h-screen bg-gray-100">
      <aside className="w-64 bg-gray-900 text-white p-6 overflow-y-auto">
        ...
        <nav className="space-y-4">
          <a href="/admin/dashboard" className="block px-4 py-2 rounded hover:bg-gray-800">Painel</a>
          ...
          <a href="/admin/settings" className="block px-4 py-2 rounded hover:bg-gray-800">Configurações</a>
        </nav>
      </aside>
